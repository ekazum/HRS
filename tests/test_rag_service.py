...
class TestRAGService(unittest.TestCase):
    ...
    @patch('LLM.RAG.rag_service.chromadb.PersistentClient')
    @patch('LLM.RAG.rag_service.SentenceTransformer')
    @patch('os.makedirs')
...
class TestGetRAGService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import LLM.RAG.rag_service
        LLM.RAG.rag_service._rag_service = None
    ...
    @patch('LLM.RAG.rag_service.RAGService')
